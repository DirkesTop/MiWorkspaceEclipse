...
public class Session {
	...
	public void login() {  // Método para iniciar sesión
		String username = Input.getString("Usuario: "); 	// Pide el nombre de usuario
		String password = Input.getString("Contraseña: ");	// Pide la contraseña
